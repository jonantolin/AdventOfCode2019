  ...
  public analizarIntCode = () => {
    ...
    while (
      ...
      switch (codInstruccion) {
        case "1":
          this.instruccion1(param1ConModo, param2ConModo, escrituraParam, modoEscritura);
          contador += 4;
          break;
        case "2":
          this.instruccion2(param1ConModo, param2ConModo, escrituraParam, modoEscritura);       
          contador += 4;
          break;
        case "3":
        ...
        case "6":
          ...
          break;
        case "7":
          this.instruccion7(param1ConModo, param2ConModo, escrituraParam, modoEscritura);
          contador += 4;
          break;
        case "8":
          this.instruccion8(param1ConModo, param2ConModo, escrituraParam, modoEscritura);
          contador += 4;
          break;
        case "9":
