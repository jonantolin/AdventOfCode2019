export class CalculadoresInstrucciones {
    ...
    public instruccion1 = (param1: number, param2: number, escrituraParam: number, modoEscritura: number) => {
    ...
    public instruccion2 = (param1: number, param2: number, escrituraParam: number, modoEscritura: number) => {
      if(modoEscritura === 2){
        escrituraParam = escrituraParam + this.baseRelativa;
      }
      this.codigosCopia[escrituraParam] = param1 * param2;
    ...
    public instruccion3 = (entradaElegida: number, param1: number, modo: number) => {
      if(modo === 2){
    ...
    public instruccion7 = (param1: number, param2: number, escrituraParam: number, modoEscritura: number) => {
      if(modoEscritura === 2){
        escrituraParam = escrituraParam + this.baseRelativa;
      }
      if (param1 < param2) {
    ...
    public instruccion8 = (param1: number, param2: number, escrituraParam: number, modoEscritura: number) => {
